...
var file_api_reservation_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xbc, 0x04, 0x0a, 0x12, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76,
	...
	0x6f, 0x6d, 0x2f, 0x6d, 0x61, 0x6e, 0x75, 0x65, 0x6c, 0x64, 0x65, 0x6c, 0x72, 0x65, 0x61, 0x6c,
	0x2f, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x2d, 0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x2d, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x2f, 0x61, 0x70, 0x69, 0x3b, 0x72,
...
var file_api_reservation_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
...
var file_api_reservation_proto_depIdxs = []int32{
	...
	4,  // 2: reservation.ReservationService.SetAvailability:input_type -> reservation.SetAvailabilityRequest
	6,  // 3: reservation.ReservationService.GetAvailableSlots:input_type -> reservation.GetAvailableSlotsRequest
	8,  // 4: reservation.ReservationService.ReserveSlot:input_type -> reservation.ReserveSlotRequest
	10, // 5: reservation.ReservationService.ConfirmReservation:input_type -> reservation.ConfirmReservationRequest
	0,  // 6: reservation.ReservationService.CreateProvider:input_type -> reservation.CreateProviderRequest
	2,  // 7: reservation.ReservationService.GetProvider:input_type -> reservation.GetProviderRequest
	5,  // 8: reservation.ReservationService.SetAvailability:output_type -> reservation.SetAvailabilityResponse
	7,  // 9: reservation.ReservationService.GetAvailableSlots:output_type -> reservation.GetAvailableSlotsResponse
	9,  // 10: reservation.ReservationService.ReserveSlot:output_type -> reservation.ReserveSlotResponse
	11, // 11: reservation.ReservationService.ConfirmReservation:output_type -> reservation.ConfirmReservationResponse
	1,  // 12: reservation.ReservationService.CreateProvider:output_type -> reservation.CreateProviderResponse
	3,  // 13: reservation.ReservationService.GetProvider:output_type -> reservation.GetProviderResponse
